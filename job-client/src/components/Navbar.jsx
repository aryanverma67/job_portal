     ...
     <header className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      <nav className="flex justify-between items-center py-6">
        ...
        < div className="text-base text-primary font-medium space-x-5 hidden lg:block">
            <Link to = "/login" className="py-2 px-5 border rounded-sm" >Log In</Link>
            <Link to = "/Signup" className="py-2 px-5 border rounded-sm bg-blue text-white" >Sign Up</Link>
      ...
      <div className={`px-4 bg-black py-5 rounded-sm ${isMenuOpen?"":"hidden"}`}>
        ...
        <li className="text-white py-1"><Link to = "/login" className="" >Log In</Link>
</li>
